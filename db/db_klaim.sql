...
INSERT INTO `db_klaim` VALUES (1,'CL000000001','PCR',3,'2019-07-20','Your Bluetooth switch needs to be on before Ubuntu will detect it. Most laptops have a switch or physical button you need to push to actually turn on the Bluetooth module.','Done'),(2,'CL000000002','MC',3,'2019-07-20',NULL,'Done'),(7,'CL000000007','PCR',3,'2019-02-01','Input keterangan disini','Open'),(8,'CL000000008','PCR',3,'2019-02-01','Input keterangan disini','Open'),(9,'CL000000009','PCR',3,'2019-02-01','Input keterangan disini','Open'),(10,'CL000000010','PCR',3,'2019-02-01','Input keterangan disini','Open'),(11,'CL000000011','PCR',3,'2019-02-01','Input keterangan disini','Open'),(12,'CL000000012','PCR',3,'2019-02-01','Input keterangan disini','Open'),(13,'CL000000013','PCR',3,'2019-02-01','Input keterangan disini','Open'),(14,'CL000000014','PCR',3,'2019-02-01','Input keterangan disini','Open'),(15,'CL000000015','PCR',3,'2019-02-01','Input keterangan disini','Open'),(16,'CL000000016','PCR',3,'2019-02-01','Input keterangan disini','Open');
...
INSERT INTO `db_klaim_detail` VALUES (1,1,1,'rusak','parah',0.00,'Tolak'),(2,1,5,'kuda','poni',1.20,'Ganti'),(3,1,15,'okey','ok',2.10,'Tolak'),(4,1,16,'coba 2','coba 1',0.00,'Ganti'),(5,2,16,'salah input','tidak rusak',0.00,'Ganti'),(6,15,35,'PB Jonggol','Bad Storage',0.00,'Pending'),(7,15,36,'Dc Bandung','Ban Benjol',2.50,'Pending'),(8,16,35,'PB Jonggol','Bad Storage',0.00,'Pending');
...
INSERT INTO `db_user` VALUES (1,'ts','202cb962ac59075b964b07152d234b70','m sulkan arif','TS'),(2,'dist','202cb962ac59075b964b07152d234b70','admin distributor','Distributor');
...
-- Dump completed on 2019-07-24  2:35:34
