...
CREATE TABLE `db_ban` (
  ...
  `alur_ban` double(4,1) NOT NULL,
  `pattern` varchar(100) NOT NULL,
  `brand` enum('Achilles','Corsa') NOT NULL,
  `type` enum('Tubeless','Tubetipe') NOT NULL,
  `harga` varchar(100) NOT NULL,
  `serial_l` varchar(50) DEFAULT NULL,
  `serial_r` varchar(50) DEFAULT NULL,
...
INSERT INTO `db_klaim` VALUES (1,'CL000000001','PCR',3,'2019-07-20','Your Bluetooth switch needs to be on before Ubuntu will detect it. Most laptops have a switch or physical button you need to push to actually turn on the Bluetooth module.','Done','2019-08-09 00:37:22'),(2,'CL000000002','MC',3,'2019-07-20',NULL,'Done','2019-08-09 00:37:22'),(7,'CL000000007','PCR',3,'2019-02-01','Input keterangan disini','Done','2019-08-09 00:43:27'),(8,'CL000000008','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(9,'CL000000009','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(10,'CL000000010','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(11,'CL000000011','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(12,'CL000000012','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(13,'CL000000013','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(14,'CL000000014','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(15,'CL000000015','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22'),(16,'CL000000016','PCR',3,'2019-02-01','Input keterangan disini','Open','2019-08-09 00:37:22');
...
CREATE TABLE `db_klaim_detail` (
  ...
  `keterangan` text,
  `kerusakan` text,
  `sisa_alur` decimal(5,2) DEFAULT NULL,
  `status` enum('Pending','Ganti','Tolak') NOT NULL DEFAULT 'Pending',
...
INSERT INTO `db_klaim_detail` VALUES (1,1,1,1,'rusak','parah',0.00,'Tolak'),(2,1,5,2,'kuda','poni',1.20,'Ganti'),(3,1,15,1,'okey','ok',2.10,'Tolak'),(4,1,16,1,'coba 2','coba 1',0.00,'Ganti'),(5,2,16,2,'salah input','tidak rusak',0.00,'Ganti'),(6,15,35,2,'PB Jonggol','Bad Storage',0.00,'Pending'),(7,15,36,2,'Dc Bandung','Ban Benjol',2.50,'Pending'),(8,16,35,2,'PB Jonggol','Bad Storage',0.00,'Pending');
...
INSERT INTO `db_toko` VALUES (1,'T001','maju motor','buntu','makasar',86721),(2,'T001','vsvdsv','sini','kendari',857253213);
...
-- Dump completed on 2019-08-14 13:18:13
