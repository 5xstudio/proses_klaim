                                    ...
                                    <form role="form" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="grup">
                                                <option value="PCR"<?php if ($lokasi == 'PCR') {echo "selected";} ?>>PCR</option>
                                                <option value="MC" <?php if ($lokasi == 'MC') {echo "selected";} ?>>MC</option>
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <label>Alur Ban</label>
                                            <input class="form-control" name="alur_ban" value ="<?php echo $tampil ['alur_ban'];?>" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="brand">
                                                <option value="Achilles"<?php if ($lokasi == 'Achilles') {echo "selected";} ?>>Achilles</option>
                                                <option value="Corsa" <?php if ($lokasi == 'Corsa') {echo "selected";} ?>>Corsa</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type">
                                                <option <?php if ($type == 'Tubeless') {echo "selected";} ?> value="Tubeless">Tubeless</option>
                                                <option <?php if ($type == 'Tubetype') {echo "selected";} ?> value="Tubetipe">Tube Type</option>
                                            </select>
                                        </div>
