...
<div class="panel-body">
    <a href="?page=klaim&aksi=edit_detail&id_klaim=<?= $_GET['id_klaim'] ?>" class="btn btn-primary" style="margin-bottom: 15px" <?=$_GET['status'] == 'Done' ? 'disabled' : '' ?> ><i class="fa fa-plus"></i>Tambah Data</a>
